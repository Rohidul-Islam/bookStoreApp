        ...
        <div className="max-w-screen-2xl container mx-auto md:px-20 px-4">
          <div className="navbar">
            <div className="navbar-start">
              ...
              <Link to={"/"} className="font-poppins font-bold text-2xl px-2 py-1 rounded-md cursor-pointer"
              onClick={() => scrollToTop()}
              >
                Granthalaya</Link>
            </div>
            <div className="navbar-end space-x-3">
              ...
              <div className="">
                <a className="bg-black text-white px-2 py-1 rounded-md hover:bg-gray-800 duration-300 cursor-pointer"
